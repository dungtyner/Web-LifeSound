<?php
    ...
    <div class="container text-center">
        <div class="row rowmain first-border" data-id="ANHYEUEM3000">
            <div class="col-8">
                <div class="row">
                    <b>Order Detail: ANHYEUEM3000</b>
                </div>
                <div class="row">
            ...
            <div class="col-4">
                <div class="border-collapse open" data-id="ANHYEUEM3000">
                    <i class="fa-solid fa-chevron-down"></i>
                </div>
            </div>
        </div>

        <div class="row rowmain ANHYEUEM3000" id="offcollapsehehe">
            <table class="table">
                <thead>
                    <tr class="table-dark">
                        <th scope="col">#</th>
