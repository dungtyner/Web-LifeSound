...
function theFirstCheckLoginEd() {
    toolAccount.CheckLogined((result, image_url, name_customer) => {
        ...
        if (result) {
            ...
            document.querySelector(".header__linklist .click_show_formLogin").innerHTML =
                '<img src=" '+ image_url + ' " class="avata_customer_header"> '+ name_customer +'';
            ...
            document.querySelector(".header__linklist .click_show_formLogin").innerHTML =
                '<i class="fa-solid fa-user-tie" style="margin-right: 0.5rem"></i>Đăng Nhập';
        }
    });
}
toolCommon.loadEventShowFormPopUp(
