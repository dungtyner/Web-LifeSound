...
function setActiveInList(
    ...
    ,methodWork)
{
    var List= document.querySelectorAll(textQuery);
for(var item of List)
{
    item.addEventListener(TypeEvent,function(event)
    {
        var itemActive= elParent.querySelector(textQuery+"."+classNameActive);
        if(itemActive)itemActive.classList.remove(classNameActive);
        event.currentTarget.classList.add(classNameActive);
        if(methodWork)
        {
            methodWork(event.currentTarget.getAttribute("data-opt-product-detail"));
        }
    })
}
}
setActiveInList(".item-shortcutImage__product_detail","active",document,"click",(urlImage)=>{
    document.querySelector(".main-Image__product_detail img").src=urlImage
});
setActiveInList(".item-optionPlug-product__detail","active",document,"click",(valueOPt)=>
{
    document.querySelector(".optionPlug-product__detail .valueOptChar__product_detail").textContent=valueOPt
});
setActiveInList(".item-optionColor-product__detail","active",document,"click",(valueOPt)=>
{
    document.querySelector(".optionColor-product__detail .valueOptChar__product_detail").textContent=valueOPt
});
function EventShowElDetail(querySelectorItem,classNameShow,TypeEvent,elDetail,elParent,isRemove)
{
    var product = document.querySelector(querySelectorItem);
    product.addEventListener(TypeEvent,function(event)
    {
        
        elDetail.classList.add(classNameShow);
        var btnCLose__product_detail =elDetail.querySelector(".btnCLose__product_detail");
        btnCLose__product_detail.addEventListener(TypeEvent,function(event)
        {
            if(isRemove)
            {
                product__detail.remove();
            }
            else
            {
                product__detail.classList.remove(classNameShow);
            }
        })
    })
}
...
EventChangeWithElTabs(
    document.querySelectorAll(".item-btnTab__product_detail"),
...
function EventChangeWithElTabs(elListTab,textQueryELContentTabs,nameDataTabs,TypeEvent,elParent)
{
        for(var elItemTab of elListTab)
        {
            addClassNameWithEvent(elItemTab,"active","click",true,(eventCurrentTarget)=>{
                    removeClassName(document.querySelector(textQueryELContentTabs+("."+"active")),"active")
                    addClassName(
                        document.querySelector(textQueryELContentTabs
                            +"["+nameDataTabs+"='"+eventCurrentTarget+"']")
                        ,"active",true);
            });
        }

}
function addClassNameWithEvent(el,classNameAdd,TypeEvent,isRemoveClassName,methodWork)
{
    el.addEventListener(TypeEvent,function(event)
    {
        ...
        if(!event.currentTarget.classList.contains(classNameAdd))
        {
            ...
            methodWork(event.currentTarget.getAttribute("data-tab-product-detail"));
        }
    })
}
                ...
                <div class="partSide-product__detail">
                    <div class="side-Image__product_detail">
                        ...
                        <div class="list-shortcutImage__product_detail">
                            <div class="item-shortcutImage__product_detail active"
                            data-opt-product-detail="https://cdn.shopify.com/s/files/1/0153/8863/products/5efddaa33218b776b29aca1c167ad82f_1160x.jpg?v=1641184507"
                            >
                                <img src="https://cdn.shopify.com/s/files/1/0153/8863/products/5efddaa33218b776b29aca1c167ad82f_1160x.jpg?v=1641184507" alt="" srcset="">
                            </div>
                            <div class="item-shortcutImage__product_detail"
                            data-opt-product-detail="https://cdn.shopify.com/s/files/1/0153/8863/products/Headphone-Zone-LETSHUOER-S12-1_1000x.jpg?v=1658749480">
        ...
        <div class="container-product__comment">
            <div class="list-product__comment">
                <div class="item-product__comment">
                    ...
                    <div class="info-commenter">
                        <div class="avatar__commenter"><img src="{{asset('images/dnmn.jpg')}}" alt=""></div>
                    ...
                    <div class="main__comment">
                        ...
                        <div class="title__comment">So beautifully!!!</div>
                         ...
                         <div class="part-image__comment">
                            <div class="main-image__comment">
                                    <img src="{{asset('images/dnmn.jpg')}}" alt="">
                            </div>
                            <div class="list_shortcut-image__comment">
                                <div class="item_shortcut__comment"><img src="{{asset('images/dnmn.jpg')}}" alt=""></div>
                                <div class="item_shortcut__comment"><img src="{{asset('images/dnmn.jpg')}}" alt=""></div>
                            </div>
                         </div>   
