...
@section('contentAdmin')
        ...
        <div class="card" style="border: 2px solid black;">
            <div class="card-body">
                <div style="display: flex;justify-content: space-between">
                    ...
                    0px 34px 30px rgba(0,0,0,0.1);">Cập Nhật Công Nghệ Tai Nghe</div>
                </div>
                        ...
                        <form>
                            <div class="form-group row">
                                ...
                                <div class="form-group col-md-7">
                                    <input type="text" class="form-control" id="name_technology" placeholder="Nhập tên công nghệ" value="{{ $dataTechnology->name_tech_sound_product }}">
                                    <input type="text" id="id_tech_sound_product" value="{{ $dataTechnology->id_tech_sound_product }}" style="display: none;">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="form-group col-md-5">
                                ...
                                <div class="form-group col-md-7">
                                    <textarea class="form-control" id="description_technology" rows="3" placeholder="Mô tả công nghệ">{{ $dataTechnology->description_tech_sound_product }}</textarea>
                                </div>
                            </div>
                            <div class="form-group row" >
                                <div class="form-group col-md-5">
                            ...
                            <div class="form-group" style="text-align: center;">
                                <button type="button" class="btn btn-outline-success btn_update_new_technology"><i class="fa fa-share-square-o" aria-hidden="true" style="margin-right: 0.5rem;"></i>Cập Nhật Công Nghệ Mới</button>
                            </div>
    
                        </form>
                    </div>
                    <div class="col">
                        <img src="{{ URL::to($dataTechnology->logo_tech_sound_product) }}" class="rounded mx-auto d-block displayImageTechnology" alt="" style="width: 200px; height: 200px; object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $('.btn_update_new_technology').click(function() {
        
            let id_tech_sound_product = $('#id_tech_sound_product').val();
            ...
            if(name_tech_sound_product == '' || logo_tech_sound_product == '') {
                ...
                form.append('id_tech_sound_product', id_tech_sound_product);
                ...
                $.ajax({
                    url: '{{URL::to("admin/technology/update-new-technology")}}',
                    method: 'post',
                    data: form,
                    contentType: false,
                    processData: false,
                    ...
                    success: function(data) {
                        window.location.href = '{{URL::to("admin/technology/all-technology")}}';
                    },
                    error: function() {
