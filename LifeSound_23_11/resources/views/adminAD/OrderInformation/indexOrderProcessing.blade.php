...
@section('contentAdmin')
                ...
                <table style="margin-top:20px " class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr class="row_data_news">
                            ...
                            <td>
                                <button class="button-89 confirmDelivery" role="button"><i class="fa fa-truck" aria-hidden="true"></i> Xác Nhận Giao Hàng</button>
                            </td>
    ...
    <script>
        $('.confirmDelivery').click(function (e) {
            ...
            // console.log(dataID);
            $.ajax({
                url: '{{URL::to("admin/order/confirm-delivery")}}',
                method: 'get',
                data: {
                    id_order_infomation: dataID
                },
                success: function(data) {
                    window.location.href = '{{URL::to("admin/order/all-order-processing")}}';
                },
                error: function() {
        ...
        $('.btn-delete-order').click(function(e) {
            ...
            window.location.href = "cancel-order/" + dataID + "";
