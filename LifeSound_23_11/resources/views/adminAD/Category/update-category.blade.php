...
@section('contentAdmin')
        ...
        <div class="card" style="border: 2px solid black;">
            <div class="card-body">
                <div style="display: flex;justify-content: space-between">
                    ...
                    0px 34px 30px rgba(0,0,0,0.1);">Cập Nhật Thể Loại Tai Nghe</div>
                </div>
                        ...
                        <form>
                            <div class="form-group row">
                                ...
                                <div class="form-group col-md-7">
                                    <input type="text" class="form-control" id="name_category" placeholder="Nhập tên thể loại" value="{{ $dataCategory->name_category_product }}">
                                    <input type="text" id="id_category_product" value="{{ $dataCategory->id_category_product }}" style="display: none;">
                                </div>
                            </div>
                            <div class="form-group row" >
                                <div class="form-group col-md-5">
                            ...
                            <div class="form-group" style="text-align: center;">
                                <button type="button" class="btn btn-outline-success btn_update_new_category"><i class="fa fa-share-square-o" aria-hidden="true" style="margin-right: 0.5rem;"></i>Cập Nhật Thể Loại </button>
                            </div>
    
                        </form>
                    </div>
                    <div class="col">
                        <img src="{{ URL::to( $dataCategory->img_category_product ) }}" class="rounded mx-auto d-block displayImageCategory" alt="" style="width: 200px; height: 200px; object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $('.btn_update_new_category').click(function() {
        
            let id_category_product = $('#id_category_product').val();
            ...
            if(name_category_product == '' || name_file_Image == '') {
                ...
                form.append('id_category_product', id_category_product);
                ...
                $.ajax({
                    url: '{{URL::to("admin/category/update-new-category")}}',
                    method: 'post',
                    data: form,
                    contentType: false,
                    processData: false,
                    ...
                    success: function(data) {
                        window.location.href = '{{URL::to("admin/category/all-category")}}';
                    },
                    error: function() {
