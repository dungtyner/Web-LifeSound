        ...
        <div class="card" style="border: 2px solid black;">
            <div class="card-body">
                <div style="display: flex;justify-content: space-between">
                    ...
                    0px 34px 30px rgba(0,0,0,0.1);">Thêm Thương Hiệu</div>
                </div>
                        ...
                        <form>
                            <div class="form-group row">
                                ...
                                <div class="form-group col-md-7">
                                    <input type="text" class="form-control" id="name_brand" placeholder="Nhập tên thương hiệu">
                                </div>
                            </div>
                            <div class="form-group row" >
                                <div class="form-group col-md-5">
                            ...
                            <div class="form-group" style="text-align: center;">
                                <button type="button" class="btn btn-outline-success btn_add_new_brand"><i class="fa fa-share-square-o" aria-hidden="true" style="margin-right: 0.5rem;"></i>Thêm Thương Hiệu</button>
                            </div>
    
                        </form>
                    </div>
                    <div class="col">
                        <img src="/upload/Brand/TEST.jpg" class="rounded mx-auto d-block displayImageBrand" alt="" style="width: 200px; height: 200px; object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $('.btn_add_new_brand').click(function() {
            ...
            if(name_brand_product == '' || name_file_Image == '') {
                ...
                $.ajax({
                    url: '{{URL::to("admin/brand/add-new-brand")}}',
                    method: 'post',
                    data: form,
                    contentType: false,
                    processData: false,
                    ...
                    success: function(data) {
                        window.location.href = '{{URL::to("admin/brand/add-brand")}}';
                    },
                    error: function() {
