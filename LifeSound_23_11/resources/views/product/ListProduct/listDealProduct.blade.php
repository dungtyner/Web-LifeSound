        ...
        <div class="content-wrapper-banner">
            ...
            <div class="heading-text-banner">
                ...
                <section class="wrapper">
                    ...
                    <div class="bottom" aria-hidden="true">Sản Phẩm</div>
                </section>
                <style>
                    :root {
                        ...
                        <div class="prod-nav-list">
                            ...
                            <div class="prod-subnav-list" id="prod-dropdown-brand">
                                @foreach ($brands as $subBrands)
                                    <div class="prod-subnav-item " id_brand_product={{$subBrands->id_brand_product}}>
                        ...
                        <div  class="prod-nav-list">
                            ...
                            <div class="prod-subnav-list price-range"  id="prod-dropdown-price">
                                    <div class="prod-subnav-lists range-group">
                                        <input type="range" class="form-range subnav-item-range-price" id="myRange" name="points" value="0"  min="0" max="100000000">
                    ...
                    <div class="pull-right">
                        <ul class="pagination pagination-sm pro-page-list">
                            @for($i = 1; $i <= $total_page; $i++)
                                <li><a href="/product/product?page={{ $i }}">{{ $i }}</a></li>
                            @endfor
                        </ul>
                    </div>
                </div>
    ...
    <script>
        ...
        filterCategory.forEach(item => {
            item.addEventListener('click', function(e) {
                ...
                window.location.href = `/product/filter?filter_category=${filter_category}&&filter_price=${filter_price}`;
            });
        });
        ...
        subnavItemRangePrice.addEventListener('change', function() {
            console.log(document.querySelector('.input-price-for-search').textContent);
            // console.log(document.querySelector('.filter_category .press'));
