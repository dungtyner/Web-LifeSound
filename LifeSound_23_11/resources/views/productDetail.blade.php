...
<head>
    ...
    <script defer src="{{ URL::asset('/js/products/test_product_detail.js') }}"></script>
...
<body>
    ...
    <div id="root">
        ...
        <div id="popup-product__detail">
            <div class="container__product_detail">
                <div class="header-product__detail"><div class="btnCLose__product_detail"><i class="fa-solid fa-circle-xmark"></i>
                </div>
            </div>
