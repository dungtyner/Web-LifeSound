                                ...
                                <div class="media forum-item">
                                    ...
                                    <div class="media-body ml-3">
                                        ...
                                        <div class="mt-3 font-size-sm">
                                            <p>Hellooo :)</p>
                                            <p>
                                                Im newbie with laravel and i want to fetch data from database in realtime for my dashboard anaytics and i found a solution with ajax but it dosent work if any one have a simple solution it will be
                                                helpful
                                            </p>
                                            <p>Thank</p>
                                        </div>
                            ...
                            <div class="card-body">
                                <div class="media forum-item">
                                    ...
                                    <div class="media-body ml-3">
                                        ...
                                        <small class="text-muted ml-2">1 hour ago</small>
                                        <div class="mt-3 font-size-sm">
                                            <p>What exactly doesnt work with your ajax calls?</p>
